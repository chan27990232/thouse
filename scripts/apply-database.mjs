...
const SQL_FILES = [
  ...
  'lease_application_bank_proof.sql',
  'lease_application_workflow.sql',
  'lease_application_fix_status_waiting_typo.sql',
  'admin_support.sql',
  ...
  'calendar_days.sql',
  'calendar_days_hk_public_holidays.sql',
  'rent_payments.sql',
  'submit_rent_payment_rpc.sql',
  'confirm_rent_payment_rpc.sql',
  'property_utility_bills.sql',
  'property_utility_bills_multi.sql',
  'property_utility_bills_tenant_payable.sql',
  'property_utility_bills_tenant_payable_decimal.sql',
  'payment_deadlines.sql',
  'tenant_utility_obligations.sql',
  'submit_utility_payment_rpc.sql',
  'utility_bill_review.sql',
  'utility_bill_review_flow.sql',
  'property_utility_bills_bill_type.sql',
  'tenant_utility_obligations_bill_type.sql',
  'admin_property_manage.sql',
  'landlord_wallet.sql',
  'validate_signup_email.sql',
  'signup_email_verification.sql',
];
